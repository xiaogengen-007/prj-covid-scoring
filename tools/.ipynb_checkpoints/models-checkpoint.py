...
class SegmentationModel:
    def __init__(self,
        ...
        # Device settings
        self.batch_size = batch_size ### HJ commented 09/10/2024: device_selection needs self.batch_size
        ...
        # self.batch_size = batch_size ### HJ commented 09/10/2024: move up
        self.epochs = epochs
        ...
        ### HJ modified 09/10/2024: enable None option
        #self.run_name = '{:s}_{:s}_{:s}_{:s}'.format(self.model_name, self.encoder_name, self.encoder_weights, run_time)
        self.run_name = '{:s}_{:s}_{:s}_{:s}'.format(
            str(self.model_name) if self.model_name is not None else 'none',
            str(self.encoder_name) if self.encoder_name is not None else 'none',
            str(self.encoder_weights) if self.encoder_weights is not None else 'none',
            run_time
        )
